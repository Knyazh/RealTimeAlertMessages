...
namespace Pustok.Migrations
{
    ...
    [Migration("20230924133618_Notifications")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pustok.Database.Models.AlertMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Pustok.Database.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pustok.Database.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pustok.Database.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pustok.Database.Models.UserActivation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Pustok.Database.Models.UserNotification", b =>
                {
                    ...
                    b.HasKey("SendingUserId", "RecievingUserId", "NotificationId");
            ...
            modelBuilder.Entity("Pustok.Database.Models.AlertMessage", b =>
                {
                    b.HasOne("Pustok.Database.Models.User", "User")
            ...
            modelBuilder.Entity("Pustok.Database.Models.OrderItem", b =>
                {
                    b.HasOne("Pustok.Database.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("Pustok.Database.Models.UserActivation", b =>
                {
                    b.HasOne("Pustok.Database.Models.User", "User")
                        .WithOne("Activation")
                        .HasForeignKey("Pustok.Database.Models.UserActivation", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pustok.Database.Models.UserNotification", b =>
                {
                    b.HasOne("Pustok.Database.Models.Notification", "Notification")
                        .WithMany("UserNotifications")
                        .HasForeignKey("NotificationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pustok.Database.Models.User", "RecievingUser")
                        .WithMany("UserNotificationsReceived")
                        .HasForeignKey("RecievingUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pustok.Database.Models.User", "SendingUser")
                        .WithMany("UserNotificationsSent")
            ...
            modelBuilder.Entity("Pustok.Database.Models.User", b =>
                {
                    ...
                    b.Navigation("UserNotificationsReceived");

                    b.Navigation("UserNotificationsSent");
                });
